const english = {
  ...
  '楽譜PDFまたはMIDI（40 MBまで）': 'Score PDF or MIDI (up to 40 MB)',
  ...
  '音符を追加': 'Add a note', '追加を押してから、楽譜上の音符頭をクリックしてください。': 'Click Add a note, then click the note head on the score.',
  ...
  'PDFまたはMIDIファイルを選択してください。': 'Please select a PDF or MIDI file.',
  'MIDIを読み込みました：{notes}音、BPM {tempo}。再生または採点できます。': 'Loaded MIDI: {notes} notes at {tempo} BPM. You can play or grade it.',
